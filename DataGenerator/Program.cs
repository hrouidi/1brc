...
namespace DataGenerator
{
    public class Program
    {
        ...
        static async Task Main(string[] args)
        {
            if (args.Length != 1)
            {
                Console.WriteLine("Usage: create_measurements.sh <number of records to create>");
                Environment.Exit(1);
            }

            if (int.TryParse(args[0], out int size) == false)
            {
    ...
    {
        public static double NextGaussian(this Random random, double mean, double stddev = 1)
        {
